...
use Database\Seeders\BasicReportDataSeeder;

class SeedBasicReportData extends Command
{
    protected $signature = 'seed:basic-reports {--fresh : Run fresh migrations first}';
    protected $description = 'Seed the database with basic report data (no user roles)';

    public function handle(): int
    {
        $this->info('🌱 Seeding basic report data...');
        ...
        $this->call('db:seed', ['--class' => BasicReportDataSeeder::class]);

        $this->info('✅ Basic report data seeded successfully!');
        $this->info('');
