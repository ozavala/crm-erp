...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchase_order_items', function (Blueprint $table) {
            ...
            $table->foreignId('product_id')->nullable()->constrained('products', 'product_id')->onDelete('set null'); // Product you are purchasing
            $table->string('item_name'); // Can be product name or custom entry
            $table->text('item_description')->nullable();
            $table->integer('quantity');
            $table->decimal('unit_price', 15, 2); // Price you are paying
