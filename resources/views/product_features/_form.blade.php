...
<button type="submit" class="btn btn-primary">{{ isset($productFeature) ? 'Update Feature' : 'Create Feature' }}</button>
<a href="{{ route('product-features.index') }}" class="btn btn-secondary">Cancel</a>