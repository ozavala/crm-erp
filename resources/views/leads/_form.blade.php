...
<div class="row">
    <div class="col-md-8 mb-3">
        <label for="title" class="form-label">{{ __('leads.Title') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-4 mb-3">
        <label for="value" class="form-label">{{ __('leads.Potential Value ($)') }}</label>
...
<div class="mb-3">
    <label for="description" class="form-label">{{ __('leads.Description') }}</label>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="status" class="form-label">{{ __('leads.Status') }} <span class="text-danger">*</span></label>
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="form-select @error('source') is-invalid @enderror" id="source" name="source">
            <option value="">{{ __('leads.Select Source') }}</option>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="customer_id" class="form-label">{{ __('leads.Associated Customer (Optional)') }}</label>
        <select class="form-select @error('customer_id') is-invalid @enderror" id="customer_id" name="customer_id">
            <option value="">{{ __('leads.None / New Contact') }}</option>
    ...
    <div class="col-md-6 mb-3">
        <label for="assigned_to_user_id" class="form-label">{{ __('leads.Assigned To') }}</label>
...
<fieldset class="mb-3 border p-3">
    <legend class="w-auto px-2 h6">{{ __('leads.Contact Information (if not existing customer)') }}</legend>
    <div class="row">
        <div class="col-md-4 mb-3">
            <label for="contact_name" class="form-label">{{ __('leads.Contact Name') }}</label>
        ...
        <div class="col-md-4 mb-3">
            <label for="contact_email" class="form-label">{{ __('leads.Contact Email') }}</label>
        ...
        <div class="col-md-4 mb-3">
            <label for="contact_phone" class="form-label">{{ __('leads.Contact Phone') }}</label>
...
<div class="mb-3">
    <label for="expected_close_date" class="form-label">{{ __('leads.Expected Close Date') }}</label>
...
<div class="mt-4">
    <button type="submit" class="btn btn-primary">{{ isset($lead) ? __('leads.Update Lead') : __('leads.Create Lead') }}</button>
    <a href="{{ route('leads.index') }}" class="btn btn-secondary">{{ __('leads.Cancel') }}</a>
</div>