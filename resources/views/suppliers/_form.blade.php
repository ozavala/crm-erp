...
<div class="row">
    <div class="col-md-12 mb-3">
        <label for="name" class="form-label">{{ __('suppliers.name') }} <span class="text-danger">*</span></label>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="phone_number" class="form-label">{{ __('suppliers.phone_number') }}</label>
...
<hr>
<h5>{{ __('suppliers.primary_address') }}</h5>
@php
...
<div class="row">
    <div class="col-md-4 mb-3">
        <label for="address_type_0" class="form-label">{{ __('suppliers.address_type') }}</label>
     ...
     <div class="col-md-8 mb-3">
        <label for="street_address_line_1_0" class="form-label">{{ __('suppliers.street_address_line_1') }}</label>
...
<div class="mb-3">
    <label for="street_address_line_2_0" class="form-label">{{ __('suppliers.street_address_line_2') }}</label>
...
<div class="row">
    <div class="col-md-4 mb-3">
        <label for="city_0" class="form-label">{{ __('suppliers.city') }}</label>
    ...
    <div class="col-md-4 mb-3">
        <label for="state_province_0" class="form-label">{{ __('suppliers.state_province') }}</label>
    ...
    <div class="col-md-4 mb-3">
        <label for="postal_code_0" class="form-label">{{ __('suppliers.postal_code') }}</label>
...
<div class="row align-items-center">
    <div class="col-md-4 mb-3">
        <label for="country_code_0" class="form-label">{{ __('suppliers.country_code_2_letter') }}</label>
    ...
    <div class="col-md-4 mb-3 mt-3 form-check">
        ...
        <label class="form-check-label" for="is_primary_0">{{ __('suppliers.set_as_primary_address') }}</label>
...
<div class="mt-4">
    <button type="submit" class="btn btn-primary">{{ isset($supplier->supplier_id) ? __('suppliers.update_supplier') : __('suppliers.create_supplier') }}</button>
