...
<div class="row">
    <div class="col-md-4 mb-3">
        <label for="address_type_0" class="form-label">Addres Type</label>
     ...
     <div class="col-md-8 mb-3">
        <label for="street_address_line_1_0" class="form-label">Address 1</label>
...
<div class="mb-3">
    <label for="street_address_line_2_0" class="form-label">Address 2</label>
...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        <label for="state_province_0" class="form-label">State</label>
...
<div class="row align-items-center">
    ...
    <div class="col-md-4 mb-3 mt-3 form-check">
        ...
        <label class="form-check-label" for="is_primary_0">Main Address</label>
