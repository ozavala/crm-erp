<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">{{ __('partials.Record a Payment') }}</h5>
    </div>
    <div class="card-body">
            ...
            <form action="{{ $form_url }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="payment_date" class="form-label">{{ __('partials.Payment Date') }}</label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="amount" class="form-label">{{ __('partials.Amount') }}</label>
                ...
                <button type="submit" class="btn btn-primary">{{ __('partials.Record Payment') }}</button>
            </form>
        @else
