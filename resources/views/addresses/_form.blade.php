...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="addressable_type" class="form-label">Type <span class="text-danger">*</span></label>
        <input type="text" class="form-control @error('addressable_type') is-invalid @enderror" id="addressable_type" name="addressable_type" value="{{ old('addressable_type', $address->addressable_type ?? 'App\\Models\\Customer') }}" placeholder="e.g., Customer" required>
        @error('addressable_type') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    <div class="col-md-6 mb-3">
        <label for="addressable_id" class="form-label">Related ID <span class="text-danger">*</span></label>
...
<div class="mb-3">
    <label for="street_address_line_1" class="form-label">Street <span class="text-danger">*</span></label>
...
<div class="mb-3">
    <label for="street_address_line_2" class="form-label">Street 2</label>
...
<div class="mb-3 form-check">
    ...
    <label class="form-check-label" for="is_primary">Primary Address</label>
