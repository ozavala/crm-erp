...
@section('content')
    <div class="container">
        <h1>{{ __('reports.Sales by Product Report') }}</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">{{ __('reports.Sales by Product Chart') }}</div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">{{ __('reports.Sales by Product Data') }}</div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            <th>{{ __('reports.Product Name') }}</th>
