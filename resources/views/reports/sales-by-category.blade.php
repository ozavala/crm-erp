...
@section('content')
    <div class="container">
        <h1>{{ __('reports.Sales by Category Report') }}</h1>
        ...
        <div class="card mb-4">
            <div class="card-header">{{ __('reports.Sales by Category Chart') }}</div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">{{ __('reports.Sales by Category Data') }}</div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            <th>{{ __('reports.Category Name') }}</th>
