...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateTotals() {
        ...
        if (Math.abs(debits - credits) < 0.001 && (debits > 0 || credits > 0) ) { // Using a small tolerance for float comparison
            ...
            balanceStatusEl.textContent = 'Out of Balance';
        ...
        addLineBtn.addEventListener('click', function () {
            ...
            newRow.innerHTML = `
                <div class="col-md-5 mb-2">
                    ...
                    <input type="text" name="lines[${lineRowIndex}][account_name]" class="form-control" placeholder="e.g., Cash, Office Expense" required>
                </div>
