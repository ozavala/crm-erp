        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-muted small">Open Quotations</div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="{{ route('invoices.create') }}" class="btn btn-outline-primary btn-sm mb-1 w-100">+ New Invoice</a>
                    <a href="{{ route('quotations.create') }}" class="btn btn-outline-info btn-sm mb-1 w-100">+ New Quotation</a>
                    <a href="{{ route('customers.create') }}" class="btn btn-outline-success btn-sm w-100">+ New Customer</a>
                </div>
            </div>
        </div>
    </div>
