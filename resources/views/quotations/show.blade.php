...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <a href="{{ route('quotations.edit', $quotation->quotation_id) }}" class="btn btn-warning">Edit Quotation</a>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body d-flex gap-2">
            ...
            @elseif($quotation->status == 'Accepted')
                ...
                @endif
            @else
                <p class="mb-0">No further actions for status: <strong>{{ $quotation->status }}</strong></p>
            @endif
        </div>
    </div>
    ...
    <div class="mb-3">
        <a href="{{ route('quotations.pdf', $quotation) }}" class="btn btn-outline-primary" target="_blank"><i class="bi bi-file-earmark-pdf"></i> Download PDF</a>
    </div>
