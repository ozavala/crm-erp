...
<div class="container">
    ...
    <div class="mb-3">
        <form action="{{ route('quotations.index') }}" method="GET">
            <div class="row g-2">
                <div class="col-md-6">
                    <input type="text" name="search" class="form-control" placeholder="Search quotations..." value="{{ request('search') }}">
                </div>
                <div class="col-md-3">
        ...
        <tbody>
            @forelse ($quotations as $quotation)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('quotations.edit', $quotation->quotation_id) }}" class="btn btn-warning btn-sm">Edit Quotation</a>
