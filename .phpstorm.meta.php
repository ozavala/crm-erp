...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\codigo\\crm-erp\\public\\storage','logging.default','logging.deprecations.channel',
...
'profile.destroy','crm-users.index','crm-users.create','crm-users.store','crm-users.show',
'crm-users.edit','crm-users.update','crm-users.destroy','user-roles.index','user-roles.create',
'user-roles.store','user-roles.show','user-roles.edit','user-roles.update','user-roles.destroy',
'permissions.index','permissions.create','permissions.store','permissions.show','permissions.edit',
'permissions.update','permissions.destroy','customers.index','customers.create','customers.store',
'customers.show','customers.edit','customers.update','customers.destroy','contacts.index',
'contacts.create','contacts.store','contacts.show','contacts.edit','contacts.update',
'contacts.destroy','leads.index','leads.create','leads.store','leads.show',
'leads.edit','leads.update','leads.destroy','leads.activities.store','products.index',
'products.create','products.store','products.show','products.edit','products.update',
'products.destroy','product-features.index','product-features.create','product-features.store','product-features.show',
'product-features.edit','product-features.update','product-features.destroy','product-categories.index','product-categories.create',
'product-categories.store','product-categories.show','product-categories.edit','product-categories.update','product-categories.destroy',
'warehouses.index','warehouses.create','warehouses.store','warehouses.show','warehouses.edit',
'warehouses.update','warehouses.destroy','customers.contacts','opportunities.kanban','opportunities.updateStage',
'opportunities.index','opportunities.create','opportunities.store','opportunities.show','opportunities.edit',
'opportunities.update','opportunities.destroy','quotations.index','quotations.create','quotations.store',
'quotations.show','quotations.edit','quotations.update','quotations.destroy','orders.index',
'orders.create','orders.store','orders.show','orders.edit','orders.update',
'orders.destroy','suppliers.index','suppliers.create','suppliers.store','suppliers.show',
'suppliers.edit','suppliers.update','suppliers.destroy','purchase-orders.index','purchase-orders.create',
'purchase-orders.store','purchase-orders.show','purchase-orders.edit','purchase-orders.update','purchase-orders.destroy',
'addresses.index','addresses.create','addresses.store','addresses.show','addresses.edit',
'addresses.update','addresses.destroy','invoices.index','invoices.create','invoices.store',
'invoices.show','invoices.edit','invoices.update','invoices.destroy','journal-entries.index',
'journal-entries.create','journal-entries.store','journal-entries.show','journal-entries.edit','journal-entries.update',
'journal-entries.destroy','purchase-orders.payments.store','bills.payments.store','payments.destroy','payments.index',
...
'landed-costs.apportion','goods-receipts.create','goods-receipts.store','goods-receipts.show','register','login','password.request','password.email',
...
'customers.index','customers.show','dashboard','goods-receipts.create','goods-receipts.show',
'home','invoices._form','invoices.create','invoices.edit','invoices.index',
'journal_entries._form','journal_entries._form_scripts','journal_entries.create','journal_entries.edit','journal_entries.index',
'journal_entries.show','layouts.app','layouts.guest','layouts.navigation','leads._form',
'leads.create','leads.edit','leads.index','leads.show','opportunities._form',
'opportunities._kanban_card','opportunities.create','opportunities.edit','opportunities.index','opportunities.kanban',
'opportunities.show','orders._form','orders.create','orders.edit','orders.index',
'orders.show','partials._notes','partials._tasks','payments._form','payments.index',
'payments.show','permissions.create','permissions.edit','permissions.index','permissions.show',
'product_categories._form','product_categories.create','product_categories.edit','product_categories.index','product_categories.show',
'product_features._form','product_features.create','product_features.edit','product_features.index','products._form',
'products.create','products.edit','products.index','products.show','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','purchase_orders._form','purchase_orders.create',
'purchase_orders.edit','purchase_orders.index','purchase_orders.pdf','purchase_orders.show','quotations._form',
'quotations.create','quotations.edit','quotations.index','suppliers._form','suppliers.create',
'suppliers.edit','suppliers.index','suppliers.show','user_roles.create','user_roles.edit',
'user_roles.index','user_roles.show','warehouses._form','warehouses.create','warehouses.edit',
'warehouses.index','warehouses.show','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
